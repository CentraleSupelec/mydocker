...
- Handle external access by magic link to courses for which the option is activated
...
## 2.31.2
### Added
- Add constraints to containers to run on specific resources (shared/reserved for the course)

## 2.31.1
### Added
- Add shutdown endpoint for DockerImageTestController
