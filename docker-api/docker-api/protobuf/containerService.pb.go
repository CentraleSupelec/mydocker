...
var file_containerService_proto_rawDesc = []byte{
	...
	0x6e, 0x54, 0x69, 0x6d, 0x65, 0x2a, 0x2d, 0x0a, 0x0e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	...
	0x42, 0x44, 0x10, 0x02, 0x32, 0xcb, 0x08, 0x0a, 0x10, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
...
var file_containerService_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_containerService_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_containerService_proto_goTypes = []interface{}{
	...
	(*NodeIPRequest)(nil),             // 3: fr.centralesupelec.gRPC.NodeIPRequest
	(*NodeIPResponse)(nil),            // 4: fr.centralesupelec.gRPC.NodeIPResponse
	(*InitAutoscalingRequest)(nil),    // 5: fr.centralesupelec.gRPC.InitAutoscalingRequest
	(*OwnerAutoscalingConfig)(nil),    // 6: fr.centralesupelec.gRPC.OwnerAutoscalingConfig
	(*ScalingRegion)(nil),             // 7: fr.centralesupelec.gRPC.ScalingRegion
	(*InitAutoscalingResponse)(nil),   // 8: fr.centralesupelec.gRPC.InitAutoscalingResponse
	(*LogRequest)(nil),                // 9: fr.centralesupelec.gRPC.LogRequest
	(*LogResponse)(nil),               // 10: fr.centralesupelec.gRPC.LogResponse
	(*UserPasswordMethod)(nil),        // 11: fr.centralesupelec.gRPC.UserPasswordMethod
	(*AuthenticationKeyMethod)(nil),   // 12: fr.centralesupelec.gRPC.AuthenticationKeyMethod
	(*ResourceLimit)(nil),             // 13: fr.centralesupelec.gRPC.ResourceLimit
	(*Metadata)(nil),                  // 14: fr.centralesupelec.gRPC.Metadata
	(*RequestPort)(nil),               // 15: fr.centralesupelec.gRPC.RequestPort
	(*ResponsePort)(nil),              // 16: fr.centralesupelec.gRPC.ResponsePort
	(*Label)(nil),                     // 17: fr.centralesupelec.gRPC.Label
	(*ContainerRequestOptions)(nil),   // 18: fr.centralesupelec.gRPC.ContainerRequestOptions
	(*ContainerRequest)(nil),          // 19: fr.centralesupelec.gRPC.ContainerRequest
	(*ContainerResponse)(nil),         // 20: fr.centralesupelec.gRPC.ContainerResponse
	(*AdminContainerRequest)(nil),     // 21: fr.centralesupelec.gRPC.AdminContainerRequest
	(*AdminContainerResponse)(nil),    // 22: fr.centralesupelec.gRPC.AdminContainerResponse
	(*SaveDataRequest)(nil),           // 23: fr.centralesupelec.gRPC.SaveDataRequest
	(*SaveDataResponse)(nil),          // 24: fr.centralesupelec.gRPC.SaveDataResponse
	(*ShutdownContainerRequest)(nil),  // 25: fr.centralesupelec.gRPC.ShutdownContainerRequest
	(*ShutdownContainerResponse)(nil), // 26: fr.centralesupelec.gRPC.ShutdownContainerResponse
	(*DockerImageRequest)(nil),        // 27: fr.centralesupelec.gRPC.DockerImageRequest
	(*DockerImageResponse)(nil),       // 28: fr.centralesupelec.gRPC.DockerImageResponse
	(*Worker)(nil),                    // 29: fr.centralesupelec.gRPC.Worker
	(*DeployRequest)(nil),             // 30: fr.centralesupelec.gRPC.DeployRequest
	(*DeployResponse)(nil),            // 31: fr.centralesupelec.gRPC.DeployResponse
	(*DelayDeletionRequest)(nil),      // 32: fr.centralesupelec.gRPC.DelayDeletionRequest
	(*DelayDeletionResponse)(nil),     // 33: fr.centralesupelec.gRPC.DelayDeletionResponse
	nil,                               // 34: fr.centralesupelec.gRPC.InitAutoscalingRequest.OwnersEntry
	nil,                               // 35: fr.centralesupelec.gRPC.Metadata.TagsEntry
	(*ContainerRequestOptions_AuthenticationKeyOption)(nil), // 36: fr.centralesupelec.gRPC.ContainerRequestOptions.AuthenticationKeyOption
	nil, // 37: fr.centralesupelec.gRPC.ContainerRequestOptions.GenericResourcesEntry
	nil, // 38: fr.centralesupelec.gRPC.ContainerResponse.ErrorParamsEntry
}
var file_containerService_proto_depIdxs = []int32{
	34, // 0: fr.centralesupelec.gRPC.InitAutoscalingRequest.owners:type_name -> fr.centralesupelec.gRPC.InitAutoscalingRequest.OwnersEntry
	7,  // 1: fr.centralesupelec.gRPC.OwnerAutoscalingConfig.regions:type_name -> fr.centralesupelec.gRPC.ScalingRegion
	35, // 2: fr.centralesupelec.gRPC.Metadata.tags:type_name -> fr.centralesupelec.gRPC.Metadata.TagsEntry
	36, // 3: fr.centralesupelec.gRPC.ContainerRequestOptions.authenticationKey:type_name -> fr.centralesupelec.gRPC.ContainerRequestOptions.AuthenticationKeyOption
	13, // 4: fr.centralesupelec.gRPC.ContainerRequestOptions.limit:type_name -> fr.centralesupelec.gRPC.ResourceLimit
	11, // 5: fr.centralesupelec.gRPC.ContainerRequestOptions.userPassword:type_name -> fr.centralesupelec.gRPC.UserPasswordMethod
	37, // 6: fr.centralesupelec.gRPC.ContainerRequestOptions.genericResources:type_name -> fr.centralesupelec.gRPC.ContainerRequestOptions.GenericResourcesEntry
	17, // 7: fr.centralesupelec.gRPC.ContainerRequestOptions.forbiddenLabels:type_name -> fr.centralesupelec.gRPC.Label
	17, // 8: fr.centralesupelec.gRPC.ContainerRequestOptions.mandatoryLabels:type_name -> fr.centralesupelec.gRPC.Label
	0,  // 9: fr.centralesupelec.gRPC.ContainerRequestOptions.storageBackend:type_name -> fr.centralesupelec.gRPC.StorageBackend
	14, // 10: fr.centralesupelec.gRPC.ContainerRequest.metadata:type_name -> fr.centralesupelec.gRPC.Metadata
	18, // 11: fr.centralesupelec.gRPC.ContainerRequest.options:type_name -> fr.centralesupelec.gRPC.ContainerRequestOptions
	15, // 12: fr.centralesupelec.gRPC.ContainerRequest.ports:type_name -> fr.centralesupelec.gRPC.RequestPort
	16, // 13: fr.centralesupelec.gRPC.ContainerResponse.ports:type_name -> fr.centralesupelec.gRPC.ResponsePort
	18, // 14: fr.centralesupelec.gRPC.ContainerResponse.options:type_name -> fr.centralesupelec.gRPC.ContainerRequestOptions
	11, // 15: fr.centralesupelec.gRPC.ContainerResponse.userPassword:type_name -> fr.centralesupelec.gRPC.UserPasswordMethod
	12, // 16: fr.centralesupelec.gRPC.ContainerResponse.authenticationKey:type_name -> fr.centralesupelec.gRPC.AuthenticationKeyMethod
	38, // 17: fr.centralesupelec.gRPC.ContainerResponse.errorParams:type_name -> fr.centralesupelec.gRPC.ContainerResponse.ErrorParamsEntry
	15, // 18: fr.centralesupelec.gRPC.AdminContainerRequest.port:type_name -> fr.centralesupelec.gRPC.RequestPort
	16, // 19: fr.centralesupelec.gRPC.AdminContainerResponse.port:type_name -> fr.centralesupelec.gRPC.ResponsePort
	11, // 20: fr.centralesupelec.gRPC.AdminContainerResponse.userPassword:type_name -> fr.centralesupelec.gRPC.UserPasswordMethod
	14, // 21: fr.centralesupelec.gRPC.SaveDataRequest.metadata:type_name -> fr.centralesupelec.gRPC.Metadata
	1,  // 22: fr.centralesupelec.gRPC.DockerImageResponse.status:type_name -> fr.centralesupelec.gRPC.DockerImageResponse.Status
	29, // 23: fr.centralesupelec.gRPC.DeployRequest.workers:type_name -> fr.centralesupelec.gRPC.Worker
	2,  // 24: fr.centralesupelec.gRPC.DeployResponse.status:type_name -> fr.centralesupelec.gRPC.DeployResponse.Status
	14, // 25: fr.centralesupelec.gRPC.DelayDeletionRequest.metadata:type_name -> fr.centralesupelec.gRPC.Metadata
	6,  // 26: fr.centralesupelec.gRPC.InitAutoscalingRequest.OwnersEntry.value:type_name -> fr.centralesupelec.gRPC.OwnerAutoscalingConfig
	19, // 27: fr.centralesupelec.gRPC.containerService.getContainer:input_type -> fr.centralesupelec.gRPC.ContainerRequest
	23, // 28: fr.centralesupelec.gRPC.containerService.saveData:input_type -> fr.centralesupelec.gRPC.SaveDataRequest
	21, // 29: fr.centralesupelec.gRPC.containerService.getAdminContainer:input_type -> fr.centralesupelec.gRPC.AdminContainerRequest
	27, // 30: fr.centralesupelec.gRPC.containerService.buildDockerImage:input_type -> fr.centralesupelec.gRPC.DockerImageRequest
	30, // 31: fr.centralesupelec.gRPC.containerService.deployInfra:input_type -> fr.centralesupelec.gRPC.DeployRequest
	9,  // 32: fr.centralesupelec.gRPC.containerService.getLogs:input_type -> fr.centralesupelec.gRPC.LogRequest
	25, // 33: fr.centralesupelec.gRPC.containerService.shutdownContainer:input_type -> fr.centralesupelec.gRPC.ShutdownContainerRequest
	32, // 34: fr.centralesupelec.gRPC.containerService.delayDeletion:input_type -> fr.centralesupelec.gRPC.DelayDeletionRequest
	5,  // 35: fr.centralesupelec.gRPC.containerService.initAutoscaling:input_type -> fr.centralesupelec.gRPC.InitAutoscalingRequest
	3,  // 36: fr.centralesupelec.gRPC.containerService.getNodeIP:input_type -> fr.centralesupelec.gRPC.NodeIPRequest
	20, // 37: fr.centralesupelec.gRPC.containerService.getContainer:output_type -> fr.centralesupelec.gRPC.ContainerResponse
	24, // 38: fr.centralesupelec.gRPC.containerService.saveData:output_type -> fr.centralesupelec.gRPC.SaveDataResponse
	22, // 39: fr.centralesupelec.gRPC.containerService.getAdminContainer:output_type -> fr.centralesupelec.gRPC.AdminContainerResponse
	28, // 40: fr.centralesupelec.gRPC.containerService.buildDockerImage:output_type -> fr.centralesupelec.gRPC.DockerImageResponse
	31, // 41: fr.centralesupelec.gRPC.containerService.deployInfra:output_type -> fr.centralesupelec.gRPC.DeployResponse
	10, // 42: fr.centralesupelec.gRPC.containerService.getLogs:output_type -> fr.centralesupelec.gRPC.LogResponse
	26, // 43: fr.centralesupelec.gRPC.containerService.shutdownContainer:output_type -> fr.centralesupelec.gRPC.ShutdownContainerResponse
	33, // 44: fr.centralesupelec.gRPC.containerService.delayDeletion:output_type -> fr.centralesupelec.gRPC.DelayDeletionResponse
	8,  // 45: fr.centralesupelec.gRPC.containerService.initAutoscaling:output_type -> fr.centralesupelec.gRPC.InitAutoscalingResponse
	4,  // 46: fr.centralesupelec.gRPC.containerService.getNodeIP:output_type -> fr.centralesupelec.gRPC.NodeIPResponse
